    ...
    <div className="p-4 md:p-6 max-w-2xl mx-auto">
      ...
      <div className="space-y-3">
        ...
        <SectionCard title="支払時期">
          <BulletList
            items={[
              'お見合いの日程確定後、決済ボタンを押した時点で決済(申請時点・承認前は費用は発生しません)',
              '月額プランは毎月自動決済',
            ]}
          />
        </SectionCard>
        ...
        <SectionCard title="サービス提供時期">
          <BulletList
            items={[
              '会員登録：本人確認審査完了後',
              'お見合い(Google Meetのご案内)：日程確定後の決済完了後即時',
              '月額プラン：決済完了後即時',
            ]}
          />
        </SectionCard>
        ...
        <SectionCard title="キャンセル・返金ポリシー" variant="warning">
          ...
          <BulletList
            color="yellow"
            items={[
              'お見合い申請料は、お見合いの日程確定後にお支払いいただきます(申請時点・承認前は費用は発生しません)',
              'お支払い後は原則返金不可です(相手が申請を承認しなかった場合はお支払い自体が発生していないため、返金の必要もありません)',
              '月額プランは次回更新日の前日までに解約申請で翌月より停止(更新日は契約開始日を基準とした毎月の周期です)',
