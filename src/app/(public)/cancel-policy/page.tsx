...
const POLICIES = [
  {
    ...
    detail: 'お見合い料（無料プラン3,500円・AIおすすめプラン3,000円）は、申請者・お相手それぞれがご自身のプランに応じた金額をお支払いいただきます。お見合いの3日前にご案内メールをお送りします。前々日までに入金リマインドをお送りします。前日17時までにいずれか一方でもご入金が確認できない場合、お見合いは自動的にキャンセルとなります。入金完了後は原則キャンセル不可となりますのでご注意ください。',
  },
  {
    icon: XCircle,
    color: 'text-red-400',
    ...
    detail: 'お見合い当日にキャンセルされた場合、キャンセルした本人のみ違約金が発生します。キャンセルされた側（相手）に追加の費用は一切かかりません。相手がすでにお見合い料をお支払い済みの場合は、その全額を返金いたします。違約金は、キャンセルした本人がすでにお支払い済みのお見合い料を返金しないことで充当されます。事前連絡なしのキャンセルは「ドタキャン」として扱われ、アカウント停止となる場合があります。',
  },
  {
    icon: Clock,
...
入金完了後は原則キャンセル不可となります。お見合い料のお支払いが完了した時点でキャンセルポリシーが適用されます(日程確定後、決済ボタンを押してお支払いいただくまでは適用されません)。やむを得ない場合は必ずお問い合わせページからご連絡ください。
          </p>
        </div>
      </div>
      ...
      <div className="flex items-start gap-3 bg-teal-950/30 border border-teal-800/60 rounded-2xl p-4">
        ...
        <div>
          ...
          <p className="text-teal-200/70 text-xs leading-relaxed">
            違約金はキャンセルした本人にのみ発生します。相手側に追加の費用は一切かかりません。相手がお見合い料をお支払い済みの場合は全額返金いたします。違約金はお見合い料と同額（無料プラン¥3,500・AIおすすめプラン¥3,000）となります。なお、キャンセルが多い場合には退会をお願いする場合があります。
          </p>
        </div>
      </div>
