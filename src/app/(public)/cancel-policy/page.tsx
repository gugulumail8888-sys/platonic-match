...
const POLICIES = [
  {
    ...
    detail: 'お見合い料（3,000円）はお見合いの3日前にご案内メールをお送りします。前々日までに入金リマインドをお送りします。前日17時までにご入金が確認できない場合、お見合いは自動的にキャンセルとなります。入金完了後は原則キャンセル不可となりますのでご注意ください。',
  },
  {
    icon: XCircle,
    color: 'text-red-400',
    ...
    <div className="p-6 md:p-8 max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
        ...
        <div className="space-y-3">
          {[
            { timing: '3日前', content: 'お見合い料（3,000円）入金案内メール送信', color: 'bg-teal-500' },
