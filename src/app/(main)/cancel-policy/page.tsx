...
const POLICIES = [
  {
    ...
    title: '当日キャンセル',
    timing: 'お見合い当日のキャンセル',
    penalty: '違約金が発生します（金額は別途ご案内）',
    detail: 'お見合い当日にキャンセルされた場合、相手方への迷惑料として違約金が発生します。違約金はStripe決済にてお支払いいただきます。',
  },
  {
    icon: Clock,
    ...
    penalty: '当日違約金の半額が発生します',
    detail: '前日までにキャンセルのご連絡をいただいた場合、当日キャンセル違約金の半額が発生します。必ずサイト内またはお問い合わせからご連絡ください。',
  },
  {
    icon: RefreshCw,
    color: 'text-blue-400',
  ...
  },
  {
    ...
    penalty: '違約金＋アカウント停止の可能性',
    detail: '事前連絡なしのキャンセルは「ドタキャン」として扱われます。違約金の発生に加え、理由によってはアカウントを停止いたします。やむを得ない事情がある場合は必ずご連絡ください。',
  },
];
