    ...
    <div className="p-6 max-w-2xl mx-auto space-y-4">
        ...
        <div className="px-6 pb-6">
          ...
          <div className="flex items-end justify-between -mt-12 mb-4">
            <div className="relative">
              ...
              <button className="absolute -bottom-1 -right-1 w-7 h-7 bg-primary-500 rounded-full flex items-center justify-center shadow-md hover:bg-primary-600 transition-colors">
          ...
          <div className="mb-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              {profile.is_verified && (
                <span className="bg-blue-50 text-blue-500 text-xs font-bold px-2 py-0.5 rounded-full flex items-center gap-1">
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            <div className="bg-primary-50 rounded-xl p-3 text-center">
              <div className="text-2xl font-bold text-primary-500 mb-0.5">
                {likesReceivedCount ?? 0}
              </div>
              <div className="text-xs text-gray-500">もらったいいね</div>
            </div>
            <div className="bg-gray-50 rounded-xl p-3 text-center">
              <div className="text-2xl font-bold text-gray-700 mb-0.5">
                {likesSentCount ?? 0}
              </div>
              <div className="text-xs text-gray-500">おくったいいね</div>
            </div>
          </div>

          {/* 結婚意思タグ */}
          <div className="flex flex-wrap gap-2">
            <span className="bg-primary-50 text-primary-600 text-sm px-3 py-1 rounded-full font-medium">
              💒 {MARRIAGE_INTENTION_LABELS[profile.marriage_intention]}
            </span>
            {profile.is_premium && (
              <span className="bg-gradient-to-r from-yellow-400 to-orange-400 text-white text-sm px-3 py-1 rounded-full font-medium">
                ⭐ Premium
              </span>
            )}
          </div>
      ...
      {profile.about_me && (
        <div className="bg-white rounded-3xl shadow-card p-6">
          <h2 className="font-bold text-gray-700 mb-3">自己紹介</h2>
      ...
      {/* 詳細情報 */}
      <div className="bg-white rounded-3xl shadow-card p-6">
        <h2 className="font-bold text-gray-700 mb-4">プロフィール詳細</h2>
      ...
      {/* アカウント設定 */}
      <div className="bg-white rounded-3xl shadow-card p-6">
        <h2 className="font-bold text-gray-700 mb-4">アカウント</h2>
